...
$raizDelSitio = 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/agregado/';
...
$laBitacora	 = $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/agregados/extension-agregados_'.$lapsoProceso.'.log';
...
$mensajeplanilla	= "<strong>ATENCI&Oacute;N:</strong> Inicio del Lapso Acad&eacute;mico ".$lapsoProceso.": Lunes 22/04/2013.";
